  ...
  return (
    <div className="container px-4 md:px-6 py-12 mx-auto max-w-3xl">
      ...
      <div className="relative h-[300px] w-full mb-8 rounded-lg overflow-hidden">
        <Image
          src="/Offer.jpg?height=300&width=800"
          alt="Our team"
          fill
      ...
      <ul className="list-disc pl-6 mb-8 space-y-2">
        <li>
          Curated Selection: We handpick each property in our collection to
          ensure quality and value.
        </li>
        <li>
          Transparent Pricing: No hidden fees or surprise charges – what you see
          is what you pay.
        </li>
        <li>
          24/7 Support: Our dedicated customer service team is always ready to
          assist you.
        </li>
        <li>
          Secure Booking: Your personal and payment information is protected
          with state-of-the-art security measures.
        </li>
        <li>
          Rewards Program: Earn points with every booking and enjoy exclusive
          benefits as a loyal customer.
        </li>
      </ul>
      ...
      <p className="mb-8">
        ...
        service professionals works tirelessly to bring you the best hotel
        booking experience. With backgrounds spanning across the globe, we bring
        a wealth of knowledge and perspectives to help you navigate your travel
        journey.
      </p>
